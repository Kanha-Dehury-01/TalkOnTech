...
function PostForm({ post }) {
    ...
    const submit = async (data) => {
        ...
        if (post) {
            ...
            if (file) {
                dbServices.deleteFile(post.featureImage);
            }
            ...
            const file = await dbServices.uploadFile(data.image[0]);
        ...
        <form onSubmit={handleSubmit(submit)} className="w-2/3 m-auto dark:text-white font-semibold">
            ...
            <div className="  px-2 ">
                <Input
                    label="Title :"
                    placeholder="Title"
                    className="mb-4 dark:text-white dark:bg-slate-800"
            ...
            <div className=" mt-10 px-2">
                <p className="text-xs -mb-5"> Try to give landscape image </p>
                <Input
                ...
                {post && (
                    <div className="w-full mb-4">
                        <img
                            src={dbServices.getFilePreview(post.featureImage)}
                            alt={post.title}
